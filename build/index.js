...
const mount = (app) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const httpsOptions = {
            key: fs.readFileSync(path_1.default.join(process.cwd(), 'server.key')),
            cert: fs.readFileSync(path_1.default.join(process.cwd(), 'server.crt')),
        };
        https_1.default.createServer(httpsOptions, app).listen(7000, hostname, () => {
